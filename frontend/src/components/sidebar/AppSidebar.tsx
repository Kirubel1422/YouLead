...
export default function AppSidebar() {
  ...
  const { user, isAuthenticated, hasTeam } = useSelector(
    (state: RootState) => state.base.auth
  );
          ...
          <SidebarGroupContent>
            <SidebarMenu className="px-2 space-y-1">
              {hasTeam
                ...
                : onBoardingSidebar.map(
                    (onboardingSidebar: OnboardingSidebarItem) => (
                      <SidebarMenuItem>
                        <SidebarMenuButton
