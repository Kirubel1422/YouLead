export type ActivityContext = "task" | "project" | "meeting" | "auth" | "team" | "invitation";
...
export interface ProjectAcitivity extends Omit<TaskActivity, "taskName" | "taskId" | "userIds"> {
     projectName?: string;
     teamId?: string;
}
